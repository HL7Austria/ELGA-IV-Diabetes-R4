...
* section[sectionPlanOfCare].text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\"><p>Behandlungsplan Vorsorge: Laboruntersuchung</p><p>Behandlungsplan Diabetes: Ernährungsschulung, Augenuntersuchung</p></div>"
...
Instance: example-iv-4b-problem-1
...
Instance: example-iv-4b-problem-2
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $cs-condition-clinical#active "Active"
* verificationStatus = $cs-condition-ver-status#confirmed "Confirmed"
...
Instance: example-iv-4b-problem-3
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $cs-condition-clinical#active "Active"
* verificationStatus = $cs-condition-ver-status#confirmed "Confirmed"
...
Instance: example-iv-4b-problem-4
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $cs-condition-clinical#active "Active"
* verificationStatus = $cs-condition-ver-status#confirmed "Confirmed"
...
Instance: example-iv-4b-problem-5
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $cs-condition-clinical#active "Active"
* verificationStatus = $cs-condition-ver-status#confirmed "Confirmed"
...
// Instance: example-iv-4b-careplan-labor
...
Instance: example-iv-4b-careplan-vorsorge
InstanceOf: DiabCareplan
Usage: #inline
* text.status = #additional
* text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">\n <p>Abgeschlossene Laboruntersuchung</p>\n    </div>"
...
Instance: example-iv-4b-task-labor
InstanceOf: Task
Usage: #inline
* text.status = #additional
* text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">\n <p>Abgeschlossene Laboruntersuchung</p>\n    </div>"
...
// Careplan Diabetes ***************************************
Instance: example-iv-4b-careplan-diabetes-1
InstanceOf: DiabCareplan
Usage: #inline
* text.status = #additional
...
* activity[+].reference = Reference(urn:uuid:39cd75da-2456-46a9-a703-89d8b65ae63b) "Termin für Ernährungsschulung"
...
// // Careplan careteam
// Instance: example-iv-4b-careplan-diabetes-careteam
// InstanceOf: CareTeam
// Usage: #inline
...
Instance: example-iv-4b-careplan-diabetes-eye-exam
...
Instance: example-iv-4b-careplan-diabetes-nutrition-training
InstanceOf: Appointment
Usage: #inline
* status = #booked
...
Instance: example-iv-4b-careplan-diabetes-labor
...
// Instance: example-iv-4b-careplan-diabetes-hba1c-monitoring-target
// InstanceOf: Goal
// Usage: #inline
...
// Instance: example-iv-4b-careplan-diabetes-exercise
// InstanceOf: Goal
// Usage: #inline
// * achievementStatus = $goal-achievement#in-progress "In Progress"
// * achievementStatus.text = "In Progress"
...
// Instance: example-iv-4b-careplan-diabetes-hba1c-monitoring
...
Instance: example-iv-4b-medication-summary-1
...
Instance: example-iv-4b-medication-summary-2
InstanceOf: AtApsMedicationStatement
Usage: #inline
* status = #active
...
Instance: example-iv-4b-allergy-1
...
Instance: example-iv-4b-procedure-history-1
...
Instance: example-iv-4b-medical-deviceUse-Hueftprothese
...
Instance: example-iv-4b-medical-device-Hueftprothese
...
// Instance: example-iv-4b-deviceUse-Insulinpumpe  
// InstanceOf: AtApsDeviceUseStatement
// Usage: #inline
// * status = #active
// * subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Anton Testpatient"
...
// Instance: example-iv-4b-device-Insulinpumpe
// InstanceOf: AtApsDevice
// Usage: #inline
...
Instance: example-iv-4b-Immunization-1
...
// Diagnostic Results - Performer
Instance: example-iv-4b-diagnostic-result-performer-1
...
Instance: example-iv-4b-diagnostic-specimen-1
...
Instance: example-iv-4b-diagnostic-result-1
...
Instance: example-iv-4b-diagnostic-result-2
InstanceOf: AtApsObservationResultsLaboratoryPathology
Usage: #inline
* status = #final
* category = $cs-observation-category#laboratory "Laboratory"
...
Instance: example-iv-4b-diagnostic-result-3
InstanceOf: AtApsObservationResultsLaboratoryPathology
Usage: #inline
* id = "example-iv-4b-diagnostic-result-2"
* status = #final
* category = $cs-observation-category#laboratory "Laboratory"
...
// Instance: example-iv-4b-diagnostic-specimen-2
// InstanceOf: AtApsSpecimen
// Usage: #inline
// * subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Anton Testpatient"
...
// Instance: example-iv-4b-diagnostic-result-8
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
// Instance: example-iv-4b-diagnostic-result-9
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
// * specimen = Reference(urn:uuid:ee1e26a1-caba-45f7-928e-d93fc1a47da9) "Urine specimen (example-iv-4b-diagnostic-specimen-2)"

// Instance: example-iv-4b-diagnostic-result-10
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
// Instance: example-iv-4b-diagnostic-result-11
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
// Instance: example-iv-4b-diagnostic-result-12
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
// Instance: example-iv-4b-diagnostic-result-13
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
// Instance: example-iv-4b-diagnostic-result-14
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
Instance: example-iv-4b-vital-sign-1
...
Instance: example-iv-4b-vital-sign-2
InstanceOf: AtApsObservationVitalSigns
Usage: #inline
* status = #final
* category[VSCat] = $cs-observation-category#vital-signs "Vital Signs"
...
Instance: example-iv-4b-vital-sign-3
InstanceOf: AtApsObservationVitalSigns
Usage: #inline
* status = #final
* category[VSCat] = $cs-observation-category#vital-signs "Vital Signs"
...
Instance: example-iv-4b-vital-sign-4
InstanceOf: AtApsObservationVitalSigns
Usage: #inline
* status = #final
* category[VSCat] = $cs-observation-category#vital-signs "Vital Signs"
...
Instance: example-iv-4b-vital-sign-5
InstanceOf: AtApsObservationVitalSigns
Usage: #inline
* status = #final
* category[VSCat] = $cs-observation-category#vital-signs "Vital Signs"
...
Instance: example-iv-4b-illness-history-1
InstanceOf: AtApsCondition
Usage: #inline
...
Instance: example-iv-4b-social-history-1
...
Instance: example-iv-4b-social-history-2
...
Instance: example-iv-4b-social-history-3
...
Instance: example-iv-4b-organization
InstanceOf: AtApsOrganization
Usage: #inline
...
// Arzt
Instance: example-iv-4b-practitioner-1
...
// APS Generator
Instance: example-iv-4b-author-device
InstanceOf: AtApsDevice
Usage: #inline
* patient = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Anton Testpatient"
...
// Practitioner Arzt
Instance: example-iv-4b-practitioner-iv
InstanceOf: AtApsPractitioner
Usage: #inline
* identifier.system = "urn:ietf:rfc:3986"
* identifier.value = "urn:oid:1.2.40.0.10.99.1.2.3.4"
...
Instance: example-iv-4b-patient
