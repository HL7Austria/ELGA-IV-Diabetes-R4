...
* entry[=].resource = example-iv-4-careteam-fallkoordination // DGKP Roman Nutrix
//CarePlan careteam
...
* entry[=].resource = example-iv-4-medication-summary-2  // METFORMIN HEX FTBL  500MG
...
* section[sectionMedications].text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\"><p>Ramipril 5 mg 1-0-0-0, Start 15.06.2016</p><p>Metformin 500 mg 1-0-0-0, Start 22.03.2025</p></div>"
...
Instance: example-iv-4-careplan-task-eye-exam
InstanceOf: Task
Usage: #inline
* text.status = #additional
...
Instance: example-iv-4-careplan-task-nutrition-training
InstanceOf: Task
Usage: #inline
* text.status = #additional
...
Instance: example-iv-4-careplan-task-labor-1
InstanceOf: Task
Usage: #inline
* text.status = #additional
...
* category[+] = $goal-category#behavioral "Behavioral"
...
// DGKP
Instance: example-iv-4-careteam-fallkoordination
InstanceOf: AtApsPractitioner
Usage: #inline
// * identifier.system = "urn:ietf:rfc:3986"
// * identifier.value = "urn:oid:1.2.40.0.10.99.1.2.3.4"
