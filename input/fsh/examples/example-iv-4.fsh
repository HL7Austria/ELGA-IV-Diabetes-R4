...
* entry[=].resource = example-iv-4-patient  // Anton Testpatient
// Author Device APS Generator
* entry[+].fullUrl = "urn:uuid:75db30ee-7028-486c-929a-c5126837f474"
* entry[=].resource = example-iv-4-author-device  // APS Generator
// Practitioner IV Ärztin
* entry[+].fullUrl = "urn:uuid:75db30ee-7028-486c-929a-c5126837f472"
* entry[=].resource = example-iv-4-practitioner-iv // IV Ärztin
// Practitioner Hausärztin
* entry[+].fullUrl = "urn:uuid:75db30ee-7028-486c-929a-c5126837f473"
* entry[=].resource = example-iv-4-practitioner-1  // Dr. Hanna Hausärztin
//Careplan careteam
...
* entry[=].resource = example-iv-4-organization  // Zentrale Anwendung APS

// Medication Summary
* entry[+].fullUrl = "urn:uuid:acac4c94-a752-4cf5-9a6b-0d84237d5076"
* entry[=].resource = example-iv-4-medication-summary-1   // RAMIPRIL 1A TBL  5MG
...
* entry[=].resource = example-iv-4-allergy-1 // Benzylpenicillin-Natrium

// Problem List
* entry[+].fullUrl = "urn:uuid:9d1c0b74-20c1-4603-a95a-71e6a1dc8fde"
* entry[=].resource = example-iv-4-problem-1 // Arterielle Hypertonie
* entry[+].fullUrl = "urn:uuid:8d3a18fb-3610-4bfb-9aa4-1169cc6dd2dd"
* entry[=].resource = example-iv-4-problem-2  // Adipositas
* entry[+].fullUrl = "urn:uuid:a3a9be59-ec61-4cab-92a9-9cbab6aec437"
* entry[=].resource = example-iv-4-problem-3  // Diabetes Diagnose
// Problem List - Family history
* entry[+].fullUrl = "urn:uuid:e66d8ac1-a124-4e94-be22-969c9b117ce5"
* entry[=].resource = example-iv-4-problem-4 // Familienanamnese: Vorzeitige koronare Herzerkrankung
* entry[+].fullUrl = "urn:uuid:e66d8ac1-a124-4e94-be22-969c9b117ce6"
* entry[=].resource = example-iv-4-problem-5  // Familienanamnese: Diabetes mellitus in der Familien

// History of Procedures Hüftersatz
* entry[+].fullUrl = "urn:uuid:75c46c35-8f4e-4232-b026-5672c60d076a"
* entry[=].resource = example-iv-4-procedure-history-1  // Totalersatz des linken Hüftgelenks
...
* entry[=].resource = example-iv-4-Immunization-1  // Diphtherie-Pertussis-Poliomyelitis-Tetanus

// Diagnostic Results
* entry[+].fullUrl = "urn:uuid:725bcf71-22e6-473b-a879-49a4b63cd654"
* entry[=].resource = example-iv-4-diagnostic-result-1 // Blutzuckerwert 
* entry[+].fullUrl = "urn:uuid:aeff2319-2cc2-4fba-9541-7a4de3d20f91"
* entry[=].resource = example-iv-4-diagnostic-result-2 // HbA1c Wert
* entry[+].fullUrl = "urn:uuid:d16dce15-bc5a-48a5-910e-6ac039785a2a"
* entry[=].resource = example-iv-4-diagnostic-result-3 // Kreatininwert
...
* entry[=].resource = example-iv-4-diagnostic-specimen-1  //Blutprobe
...
* entry[=].resource = example-iv-4-illness-history-1  // Masernerkrankung in der Kindheit

// Careplan Vorsorge
* entry[+].fullUrl = "urn:uuid:39cd75da-2456-46a9-a703-89d8b65ae639"
* entry[=].resource = example-iv-4-careplan-vorsorge  
// Task Laboruntersuchung
* entry[+].fullUrl = "urn:uuid:39cd75da-2456-46a9-a703-89d8b65a1234"
* entry[=].resource = example-iv-4-task-labor  // abgeschlossene Laboruntersuchung

// Careplan Diabetes  
* entry[+].fullUrl = "urn:uuid:39cd75da-2456-46a9-a703-89d8b65ae333"
* entry[=].resource = example-iv-4-careplan-diabetes-1
...
* entry[=].resource = example-iv-4-careplan-diabetes-labor
...
* entry[=].resource = example-iv-4-social-history-1  // Ehemaliger Raucher
* entry[+].fullUrl = "urn:uuid:d0a5bbf1-6d01-4d44-bac5-05f12c984112"
* entry[=].resource = example-iv-4-social-history-2   // Alkoholische Getränke pro Tag, 1-2 Gläser Wein/Bier
* entry[+].fullUrl = "urn:uuid:9add5c32-1ded-43d6-b163-c3fe13f94984"
* entry[=].resource = example-iv-4-social-history-3  // Körperliche Aktivität 2,5h/Wo
...
Instance: example-iv-4-careplan-vorsorge
InstanceOf: DiabCareplan
Usage: #inline
* text.status = #additional
* text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">\n <p>Abgeschlossene Laboruntersuchung</p>\n    </div>"
...
Instance: example-iv-4-task-labor
InstanceOf: Task
Usage: #inline
* text.status = #additional
* text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">\n <p>Abgeschlossene Laboruntersuchung</p>\n    </div>"
...
// Careplan Diabetes ***************************************
Instance: example-iv-4-careplan-diabetes-1
InstanceOf: DiabCareplan
Usage: #inline
* text.status = #additional
...
Instance: example-iv-4-careplan-diabetes-labor
...
// Practitioner Arzt
Instance: example-iv-4-practitioner-iv
InstanceOf: AtApsPractitioner
Usage: #inline
* identifier.system = "urn:ietf:rfc:3986"
* identifier.value = "urn:oid:1.2.40.0.10.99.1.2.3.4"
