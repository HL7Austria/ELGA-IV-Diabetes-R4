Instance: ex-5-poc-tx-1-careplan
InstanceOf: AtApsBundle
Title: "ex-5-poc-tx-1-careplan"
...
* entry[=].resource = ex-5-poc-tx-1-careplan-author-device  // APS Generator
* entry[=].request.method = #POST
* entry[=].request.url = "Device"

// Practitioner IV Diätologin
* entry[+].fullUrl = "urn:uuid:75db30ee-7028-486c-929a-c5126837f472"
* entry[=].resource = ex-5-poc-tx-1-careplan-practitioner-iv // IV Diätologin
* entry[=].request.method = #POST
* entry[=].request.url = "Practitioner"

// Practitioner Hausärztin
* entry[+].fullUrl = "urn:uuid:75db30ee-7028-486c-929a-c5126837f473"
* entry[=].resource = ex-5-poc-tx-1-careplan-practitioner-1  // Dr. Hanna Hausärztin
* entry[=].request.method = #POST
* entry[=].request.url = "Practitioner"

// Fallkoordination
* entry[+].fullUrl = "urn:uuid:75db30ee-7028-486c-929a-c5126837f477"
* entry[=].resource = ex-5-poc-tx-1-careplan-careteam-fallkoordination // DGKP Roman Nutrix
* entry[=].request.method = #POST
* entry[=].request.url = "Practitioner"

//CarePlan careteam
* entry[+].fullUrl = "urn:uuid:75db30ee-5555-486c-929a-c5126837f473"
* entry[=].resource = ex-5-poc-tx-1-careplan-careplan-diabetes-careteam
* entry[=].request.method = #POST
* entry[=].request.url = "CareTeam"

// Organisation
* entry[+].fullUrl = "urn:uuid:f6266e6a-f63d-4673-b2de-3dff11e619d6"
* entry[=].resource = ex-5-poc-tx-1-careplan-organization  // Zentrale Anwendung APS
* entry[=].request.method = #POST
* entry[=].request.url = "Organization"

// Medication Summary
* entry[+].fullUrl = "urn:uuid:acac4c94-a752-4cf5-9a6b-0d84237d5088"
* entry[=].resource = ex-5-poc-tx-1-careplan-medicationplan-1   // RAMIPRIL 1A TBL  5MG
* entry[=].request.method = #POST
* entry[=].request.url = "MedicationRequest"

* entry[+].fullUrl = "urn:uuid:acac4c94-a752-4cf5-9a6b-0d84237d5099"
* entry[=].resource = ex-5-poc-tx-1-careplan-medicationplan-2  // METFORMIN HEX FTBL  500MG
* entry[=].request.method = #POST
* entry[=].request.url = "MedicationRequest"
...
* entry[=].resource = ex-5-poc-tx-1-careplan-Immunization-1  // Diphtherie-Pertussis-Poliomyelitis-Tetanus
* entry[=].request.method = #POST
...
* entry[=].resource = ex-5-poc-tx-1-careplan-vital-sign-1
* entry[=].request.method = #POST
* entry[=].request.url = "Observation"

* entry[+].fullUrl = "urn:uuid:428259da-e0f7-4780-b1e3-c177515edd37"
* entry[=].resource = ex-5-poc-tx-1-careplan-vital-sign-2
* entry[=].request.method = #POST
* entry[=].request.url = "Observation"

* entry[+].fullUrl = "urn:uuid:daf9c15d-14d4-429c-b658-6842fdff67d8"
* entry[=].resource = ex-5-poc-tx-1-careplan-vital-sign-3
* entry[=].request.method = #POST
* entry[=].request.url = "Observation"

* entry[+].fullUrl = "urn:uuid:8248cc70-65a2-4d37-ae14-a3ef2abf8f32"
* entry[=].resource = ex-5-poc-tx-1-careplan-vital-sign-4
* entry[=].request.method = #POST
* entry[=].request.url = "Observation"

* entry[+].fullUrl = "urn:uuid:4d3f7ac4-fd0a-49af-a56b-303a2dbe67d1"
* entry[=].resource = ex-5-poc-tx-1-careplan-vital-sign-5
* entry[=].request.method = #POST
* entry[=].request.url = "Observation"
...
* entry[=].resource = ex-5-poc-tx-1-careplan-careplan-diabetes-1
* entry[=].request.method = #POST
...
* entry[=].resource = ex-5-poc-tx-1-careplan-careplan-task-eye-exam
* entry[=].request.method = #POST
* entry[=].request.url = "Task"

// CarePlan Diabetes - Schulung - Task 
* entry[+].fullUrl = "urn:uuid:39cd75da-2456-46a9-a703-89d8b65ae62c"
* entry[=].resource = ex-5-poc-tx-1-careplan-careplan-task-nutrition-training
* entry[=].request.method = #POST
* entry[=].request.url = "Task"

// Task Laboruntersuchung // vom Default CarePlan
* entry[+].fullUrl = "urn:uuid:39cd75da-2456-46a9-a703-89d8b65a1234"
* entry[=].resource = ex-5-poc-tx-1-careplan-careplan-task-labor-1  // abgeschlossene Laboruntersuchung
* entry[=].request.method = #POST
* entry[=].request.url = "Task"

// CarePlan Diabetes - Anforderung neue Laboruntersuchung 
* entry[+].fullUrl = "urn:uuid:39cd75da-2456-46a9-a703-89d8b65ae699"
* entry[=].resource = ex-5-poc-tx-1-careplan-careplan-task-labor-2
* entry[=].request.method = #POST
* entry[=].request.url = "Task"

// // CarePlan Zielwerte Goals
* entry[+].fullUrl = "urn:uuid:39cd75da-4444-46a9-a703-89d8b65ae777"
* entry[=].resource = ex-5-poc-tx-1-careplan-careplan-diabetes-hba1c-zielwert
* entry[=].request.method = #POST
* entry[=].request.url = "Goal"

* entry[+].fullUrl = "urn:uuid:39cd75da-9999-46a9-a703-89d8b65ae333"
* entry[=].resource = ex-5-poc-tx-1-careplan-careplan-diabetes-exercise
* entry[=].request.method = #POST
* entry[=].request.url = "Goal"

// CarePlan outcome 
// //* entry[+].fullUrl = "urn:uuid:39cd75da-3333-46a9-a703-89d8b65ae555"
// // * entry[=].resource = ex-5-poc-tx-1-careplan-careplan-diabetes-hba1c-outcome

// Social History
* entry[+].fullUrl = "urn:uuid:d0a5bbf1-6d01-4d44-bac5-05f12c98411e"
* entry[=].resource = ex-5-poc-tx-1-careplan-social-history-1  // Ehemaliger Raucher
* entry[=].request.method = #POST
* entry[=].request.url = "Observation"

* entry[+].fullUrl = "urn:uuid:d0a5bbf1-6d01-4d44-bac5-05f12c984112"
* entry[=].resource = ex-5-poc-tx-1-careplan-social-history-2   // Alkoholische Getränke pro Tag, 1-2 Gläser Wein/Bier
* entry[=].request.method = #POST
* entry[=].request.url = "Observation"

* entry[+].fullUrl = "urn:uuid:9add5c32-1ded-43d6-b163-c3fe13f94984"
* entry[=].resource = ex-5-poc-tx-1-careplan-social-history-3  // Körperliche Aktivität 2,5h/Wo
* entry[=].request.method = #POST
* entry[=].request.url = "Observation"

Instance: ex-5-poc-tx-1-careplan-composition
...
// CarePlan Diabetes ***************************************
Instance: ex-5-poc-tx-1-careplan-careplan-diabetes-1
...
// CarePlan careteam
Instance: ex-5-poc-tx-1-careplan-careplan-diabetes-careteam
InstanceOf: CareTeam
Usage: #inline
...
Instance: ex-5-poc-tx-1-careplan-careplan-task-eye-exam
InstanceOf: Task
Usage: #inline
* text.status = #additional
...
Instance: ex-5-poc-tx-1-careplan-careplan-task-nutrition-training
InstanceOf: Task
Usage: #inline
* text.status = #additional
...
Instance: ex-5-poc-tx-1-careplan-careplan-task-labor-1
InstanceOf: Task
Usage: #inline
* text.status = #additional
...
Instance: ex-5-poc-tx-1-careplan-careplan-task-labor-2
InstanceOf: Task
Usage: #inline
* text.status = #additional
...
Instance: ex-5-poc-tx-1-careplan-careplan-diabetes-hba1c-zielwert
InstanceOf: Goal
Usage: #inline
...
Instance: ex-5-poc-tx-1-careplan-careplan-diabetes-exercise
InstanceOf: Goal
Usage: #inline
* lifecycleStatus = #proposed 
// * achievementStatus = $goal-achievement#in-progress "In Progress"
...
Instance: ex-5-poc-tx-1-careplan-medicationplan-1
...
Instance: ex-5-poc-tx-1-careplan-medicationplan-2
InstanceOf: AtApsMedicationRequest
Usage: #inline
* status = #active
* intent = #plan
...
// Instance: ex-5-poc-tx-1-careplan-device-Insulinpumpe
// InstanceOf: AtApsDevice
// Usage: #inline
...
Instance: ex-5-poc-tx-1-careplan-Immunization-1
...
// GKL20250813: nicht anlegen, weil diese Info über CDA2FHIR Transformation in APS kommen soll
// Instance: ex-5-poc-tx-1-careplan-diagnostic-specimen-1
...
// GKL20250813: nicht anlegen, weil diese Info über CDA2FHIR Transformation in APS kommen soll
// Instance: ex-5-poc-tx-1-careplan-diagnostic-result-1
...
// GKL20250813: nicht anlegen, weil diese Info über CDA2FHIR Transformation in APS kommen soll
// Instance: ex-5-poc-tx-1-careplan-diagnostic-result-2
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
// GKL20250813: nicht anlegen, weil diese Info über CDA2FHIR Transformation in APS kommen soll
// Instance: ex-5-poc-tx-1-careplan-diagnostic-result-3
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
// GKL20250813: nicht anlegen, weil diese Info über CDA2FHIR Transformation in APS kommen soll
// Instance: ex-5-poc-tx-1-careplan-diagnostic-result-4
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
// GKL20250813: nicht anlegen, weil diese Info über CDA2FHIR Transformation in APS kommen soll
// Instance: ex-5-poc-tx-1-careplan-diagnostic-result-5
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
// Instance: ex-5-poc-tx-1-careplan-diagnostic-specimen-2
// InstanceOf: AtApsSpecimen
// Usage: #inline
// * subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Anton Testpatient"
...
// Instance: ex-5-poc-tx-1-careplan-diagnostic-result-8
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
// Instance: ex-5-poc-tx-1-careplan-diagnostic-result-9
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
// * specimen = Reference(urn:uuid:ee1e26a1-caba-45f7-928e-d93fc1a47da9) "Urine specimen (ex-5-poc-tx-1-careplan-diagnostic-specimen-2)"

// Instance: ex-5-poc-tx-1-careplan-diagnostic-result-10
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
// Instance: ex-5-poc-tx-1-careplan-diagnostic-result-11
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
// Instance: ex-5-poc-tx-1-careplan-diagnostic-result-12
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
// Instance: ex-5-poc-tx-1-careplan-diagnostic-result-13
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
// Instance: ex-5-poc-tx-1-careplan-diagnostic-result-14
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
Instance: ex-5-poc-tx-1-careplan-vital-sign-1
...
Instance: ex-5-poc-tx-1-careplan-vital-sign-2
InstanceOf: AtApsObservationVitalSigns
Usage: #inline
* status = #final
* category[VSCat] = $cs-observation-category#vital-signs "Vital Signs"
...
Instance: ex-5-poc-tx-1-careplan-vital-sign-3
InstanceOf: AtApsObservationVitalSigns
Usage: #inline
* status = #final
* category[VSCat] = $cs-observation-category#vital-signs "Vital Signs"
...
Instance: ex-5-poc-tx-1-careplan-vital-sign-4
InstanceOf: AtApsObservationVitalSigns
Usage: #inline
* status = #final
* category[VSCat] = $cs-observation-category#vital-signs "Vital Signs"
...
Instance: ex-5-poc-tx-1-careplan-vital-sign-5
InstanceOf: AtApsObservationVitalSigns
Usage: #inline
* status = #final
* category[VSCat] = $cs-observation-category#vital-signs "Vital Signs"
...
Instance: ex-5-poc-tx-1-careplan-social-history-1
...
Instance: ex-5-poc-tx-1-careplan-social-history-2
...
Instance: ex-5-poc-tx-1-careplan-organization
InstanceOf: AtApsOrganization
Usage: #inline
...
// Arzt
Instance: ex-5-poc-tx-1-careplan-practitioner-1
...
// DGKP
Instance: ex-5-poc-tx-1-careplan-careteam-fallkoordination
InstanceOf: AtApsPractitioner
Usage: #inline
* identifier.system = "urn:ietf:rfc:3986"
* identifier.value = "urn:oid:1.2.40.0.10.99.1.2.3.4"
...
// APS Generator
Instance: ex-5-poc-tx-1-careplan-author-device
InstanceOf: AtApsDevice
Usage: #inline
* patient = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Anton Testpatient"
...
// Practitioner Arzt
Instance: ex-5-poc-tx-1-careplan-practitioner-iv
InstanceOf: AtApsPractitioner
Usage: #inline
* identifier.system = "urn:ietf:rfc:3986"
* identifier.value = "urn:oid:1.2.40.0.10.99.1.2.3.4"
...
// Patient
Instance: ex-5-poc-tx-1-careplan-patient
