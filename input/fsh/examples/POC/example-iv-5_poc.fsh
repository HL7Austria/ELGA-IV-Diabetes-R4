...
* entry[=].resource = example-iv-5-poc-composition
// Patient
* entry[+].fullUrl = "urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8"
* entry[=].resource = example-iv-5-poc-patient  // Anton Testpatient
// Author Device APS Generator
* entry[+].fullUrl = "urn:uuid:75db30ee-7028-486c-929a-c5126837f474"
* entry[=].resource = example-iv-5-poc-author-device  // APS Generator
// Practitioner IV Diätologin
* entry[+].fullUrl = "urn:uuid:75db30ee-7028-486c-929a-c5126837f472"
* entry[=].resource = example-iv-5-poc-practitioner-iv // IV Diätologin
...
* entry[=].resource = example-iv-5-poc-careplan-diabetes-careteam
// Organisation
* entry[+].fullUrl = "urn:uuid:f6266e6a-f63d-4673-b2de-3dff11e619d6"
* entry[=].resource = example-iv-5-poc-organization  // Zentrale Anwendung APS

// Medication Summary
* entry[+].fullUrl = "urn:uuid:acac4c94-a752-4cf5-9a6b-0d84237d5088"
* entry[=].resource = example-iv-5-poc-medicationplan-1   // RAMIPRIL 1A TBL  5MG
* entry[+].fullUrl = "urn:uuid:acac4c94-a752-4cf5-9a6b-0d84237d5099"
* entry[=].resource = example-iv-5-poc-medicationplan-2  // METFORMIN HEX FTBL  500MG

// Allergies and Intolerances
* entry[+].fullUrl = "urn:uuid:768eb9cb-00f3-4ab1-bfc2-ff835cb3b89b"
* entry[=].resource = example-iv-5-poc-allergy-1 // Benzylpenicillin-Natrium

// Problem List
* entry[+].fullUrl = "urn:uuid:9d1c0b74-20c1-4603-a95a-71e6a1dc8fde"
* entry[=].resource = example-iv-5-poc-problem-1 // Arterielle Hypertonie
* entry[+].fullUrl = "urn:uuid:8d3a18fb-3610-4bfb-9aa4-1169cc6dd2dd"
* entry[=].resource = example-iv-5-poc-problem-2  // Adipositas
* entry[+].fullUrl = "urn:uuid:a3a9be59-ec61-4cab-92a9-9cbab6aec437"
* entry[=].resource = example-iv-5-poc-problem-3  // Diabetes Diagnose
// Problem List - Family history
* entry[+].fullUrl = "urn:uuid:e66d8ac1-a124-4e94-be22-969c9b117ce5"
* entry[=].resource = example-iv-5-poc-problem-4 // Familienanamnese: Vorzeitige koronare Herzerkrankung
* entry[+].fullUrl = "urn:uuid:e66d8ac1-a124-4e94-be22-969c9b117ce6"
* entry[=].resource = example-iv-5-poc-problem-5  // Familienanamnese: Diabetes mellitus in der Familien

// History of Procedures Hüftersatz
* entry[+].fullUrl = "urn:uuid:75c46c35-8f4e-4232-b026-5672c60d076a"
* entry[=].resource = example-iv-5-poc-procedure-history-1  // Totalersatz des linken Hüftgelenks
// Medical Devices Hüftimplantat
* entry[+].fullUrl = "urn:uuid:490dab5c-271e-4736-8a6b-5f6f089d0a11"
* entry[=].resource = example-iv-5-poc-medical-deviceUse-Hueftprothese
* entry[+].fullUrl = "urn:uuid:490dab5c-271e-4736-8a6b-5f6f089d0a22"
* entry[=].resource = example-iv-5-poc-medical-device-Hueftprothese

// Impfungen (Immunization)
* entry[+].fullUrl = "urn:uuid:590dab5c-271e-4736-8a6b-d04fd2a04607"
* entry[=].resource = example-iv-5-poc-Immunization-1  // Diphtherie-Pertussis-Poliomyelitis-Tetanus

// Diagnostic Results
* entry[+].fullUrl = "urn:uuid:725bcf71-22e6-473b-a879-49a4b63cd654"
* entry[=].resource = example-iv-5-poc-diagnostic-result-1 // Blutzuckerwert
* entry[+].fullUrl = "urn:uuid:aeff2319-2cc2-4fba-9541-7a4de3d20f91"
* entry[=].resource = example-iv-5-poc-diagnostic-result-2 // HbA1c Wert
* entry[+].fullUrl = "urn:uuid:d16dce15-bc5a-48a5-910e-6ac039785a2a"
* entry[=].resource = example-iv-5-poc-diagnostic-result-3 // Kreatininwert
* entry[+].fullUrl = "urn:uuid:aeff2319-2cc2-4fba-9541-7a4de3d20f92"
* entry[=].resource = example-iv-5-poc-diagnostic-result-4 // HbA1c Kontrolle
* entry[+].fullUrl = "urn:uuid:725bcf71-22e6-473b-a879-49a4b63cd655"
* entry[=].resource = example-iv-5-poc-diagnostic-result-5 // Blutzuckerwert Kontrolle

// // Urindiagnostik
// * entry[+].fullUrl = "urn:uuid:4fe4b16a-14cb-4fd6-9da6-02c4b3797fdc"
// * entry[=].resource = example-iv-5-poc-diagnostic-result-8
// * entry[+].fullUrl = "urn:uuid:24ff8632-0ccd-4279-88b2-325fdd936ecb"
// * entry[=].resource = example-iv-5-poc-diagnostic-result-9
// * entry[+].fullUrl = "urn:uuid:8c11ad58-94ec-469c-ba4d-bfba9063067d"
// * entry[=].resource = example-iv-5-poc-diagnostic-result-10
// * entry[+].fullUrl = "urn:uuid:8c7f9e94-b834-474e-818c-bbd6c3ce3e17"
// * entry[=].resource = example-iv-5-poc-diagnostic-result-11
// * entry[+].fullUrl = "urn:uuid:e6e05f94-92be-4ae3-bf49-b0b7d4a62b35"
// * entry[=].resource = example-iv-5-poc-diagnostic-result-12
// * entry[+].fullUrl = "urn:uuid:33e09da2-5f43-4046-b2eb-cf190031826b"
// * entry[=].resource = example-iv-5-poc-diagnostic-result-13
...
* entry[=].resource = example-iv-5-poc-results-performer-1-practitionerrole // Dr. Humpel, Amadeus Spital - Labor
* entry[+].fullUrl = "urn:uuid:22e82467-7d83-406e-ae02-959f85bf6bf8"
* entry[=].resource = example-iv-5-poc-results-performer-1-practitioner // Dr. Humpel
* entry[+].fullUrl = "urn:uuid:9def0abd-9809-4f60-b233-1d7a9ae6bd01"
* entry[=].resource = example-iv-5-poc-results-performer-1-organization // Amadeus Spital - Labor
* entry[+].fullUrl = "urn:uuid:26d8cedc-b202-4620-84c0-d5c7d602ac66"
...
* entry[=].resource = example-iv-5-poc-vital-sign-1
* entry[+].fullUrl = "urn:uuid:428259da-e0f7-4780-b1e3-c177515edd37"
* entry[=].resource = example-iv-5-poc-vital-sign-2
* entry[+].fullUrl = "urn:uuid:daf9c15d-14d4-429c-b658-6842fdff67d8"
* entry[=].resource = example-iv-5-poc-vital-sign-3
* entry[+].fullUrl = "urn:uuid:8248cc70-65a2-4d37-ae14-a3ef2abf8f32"
* entry[=].resource = example-iv-5-poc-vital-sign-4
* entry[+].fullUrl = "urn:uuid:4d3f7ac4-fd0a-49af-a56b-303a2dbe67d1"
* entry[=].resource = example-iv-5-poc-vital-sign-5

// Past History of Illness
* entry[+].fullUrl = "urn:uuid:82301518-66ca-4b4c-821d-087adf643cc4"
* entry[=].resource = example-iv-5-poc-illness-history-1  // Masernerkrankung in der Kindheit
...
Instance: example-iv-5-poc-problem-1
...
Instance: example-iv-5-poc-problem-2
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $cs-condition-clinical#active "Active"
* verificationStatus = $cs-condition-ver-status#confirmed "Confirmed"
...
Instance: example-iv-5-poc-problem-3
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $cs-condition-clinical#active "Active"
* verificationStatus = $cs-condition-ver-status#confirmed "Confirmed"
...
Instance: example-iv-5-poc-problem-4
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $cs-condition-clinical#active "Active"
* verificationStatus = $cs-condition-ver-status#confirmed "Confirmed"
...
Instance: example-iv-5-poc-problem-5
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $cs-condition-clinical#active "Active"
* verificationStatus = $cs-condition-ver-status#confirmed "Confirmed"
...
// CarePlan careteam
Instance: example-iv-5-poc-careplan-diabetes-careteam
InstanceOf: CareTeam
Usage: #inline
...
Instance: example-iv-5-poc-careplan-task-eye-exam
InstanceOf: Task
Usage: #inline
* text.status = #additional
...
Instance: example-iv-5-poc-careplan-task-nutrition-training
InstanceOf: Task
Usage: #inline
* text.status = #additional
...
Instance: example-iv-5-poc-careplan-task-labor-1
InstanceOf: Task
Usage: #inline
* text.status = #additional
...
Instance: example-iv-5-poc-careplan-task-labor-2
InstanceOf: Task
Usage: #inline
* text.status = #additional
...
Instance: example-iv-5-poc-careplan-diabetes-hba1c-zielwert
InstanceOf: Goal
Usage: #inline
...
Instance: example-iv-5-poc-careplan-diabetes-exercise
InstanceOf: Goal
Usage: #inline
* lifecycleStatus = #proposed
// * achievementStatus = $goal-achievement#in-progress "In Progress"
...
Instance: example-iv-5-poc-medicationplan-1
...
Instance: example-iv-5-poc-allergy-1
...
Instance: example-iv-5-poc-procedure-history-1
...
Instance: example-iv-5-poc-medical-deviceUse-Hueftprothese
...
Instance: example-iv-5-poc-medical-device-Hueftprothese
...
// Instance: example-iv-5-poc-deviceUse-Insulinpumpe
// InstanceOf: AtApsDeviceUseStatement
// Usage: #inline
// * status = #active
// * subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Anton Testpatient"
...
// Instance: example-iv-5-poc-device-Insulinpumpe
// InstanceOf: AtApsDevice
// Usage: #inline
...
Instance: example-iv-5-poc-Immunization-1
...
Instance: example-iv-5-poc-results-performer-1-practitionerrole
InstanceOf: PractitionerRole
Usage: #inline
* practitioner = Reference(urn:uuid:22e82467-7d83-406e-ae02-959f85bf6bf8)
* practitioner.type = "Practitioner"
* organization = Reference(urn:uuid:9def0abd-9809-4f60-b233-1d7a9ae6bd01)
* organization.type = "Organization"

Instance: example-iv-5-poc-results-performer-1-practitioner
InstanceOf: Practitioner
Usage: #inline
* identifier.system = "urn:oid:1.2.99.3.4.5.6.400"
* identifier.value = "4444"
* identifier.assigner.display = "Amadeus Spital - Ärzte"
* name.family = "Humpel"
* name.given = "Florian"
...
Instance: example-iv-5-poc-results-performer-1-organization
...
* address.line.extension[=].valueString = "18-20"
...
Instance: example-iv-5-poc-diagnosticreport-4-specimen-1
InstanceOf: AtApsSpecimen
Usage: #inline
* identifier.system = "urn:oid:1.2.99.3.4.5.6"
* identifier.value = "BL-121201-02"
* type = $sct#258580003 "Vollblut"
* subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Anton Testpatient"
* subject.type = "Patient"
* receivedTime = "2025-07-11T06:35:00+02:00"
...
InstanceOf: AtApsObservationResultsLaboratoryPathology
Usage: #inline
* identifier.system = "urn:oid:1.2.99.3.4.5.6.600"
* identifier.value = "OBS-3-17"
* identifier.assigner.display = "Amadeus Spital - Laboruntersuchungen"
* status = #final
* category = $cs-observation-category#laboratory "Laboratory"
* code = $cs-loinc#4548-4 "Hemoglobin A1c/Hemoglobin.total in Blood"
* subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8)
* effectiveDateTime = "2025-03-17T09:30:00+01:00"
* issued = "2025-03-17T15:30:13+01:00"
* performer = Reference(urn:uuid:26d8cedc-b202-4620-84c0-d5c7d602ac66) "Dr. Humpel, Amadeus Spital - Labor"
* performer.type = "PractitionerRole"
* valueQuantity = 8.1 '%' "%"
* specimen = Reference(urn:uuid:523614bb-79a7-44b4-b8fd-e2dc8ba28cbd) "Blutprobe"
...
Instance: example-iv-5-poc-diagnostic-result-3
InstanceOf: AtApsObservationResultsLaboratoryPathology
Usage: #inline
* identifier.system = "urn:oid:1.2.99.3.4.5.6.600"
* identifier.value = "OBS-3-18"
* identifier.assigner.display = "Amadeus Spital - Laboruntersuchungen"
* status = #final
* category = $cs-observation-category#laboratory "Laboratory"
...
* specimen = Reference(urn:uuid:523614bb-79a7-44b4-b8fd-e2dc8ba28cbd) "Blutprobe"
* interpretation.coding[0] = $cs-v3-ObservationInterpretation#N
* interpretation.coding[+] = $cs-v3-NullFlavor#OTH
* referenceRange.low = 0.7 'mg/dL' "mg/dL"
* referenceRange.high = 1.2 'mg/dL' "mg/dL"
* referenceRange.type = $cs-referencerange-meaning#normal
...
* issued = "2025-07-11T10:35:00+02:00"
* performer = Reference(urn:uuid:26d8cedc-b202-4620-84c0-d5c7d602ac66) "Dr. Humpel, Amadeus Spital - Labor"
* performer.type = "PractitionerRole"
* valueQuantity = 7.1 '%' "%"
...
// Instance: example-iv-5-poc-diagnostic-specimen-2
// InstanceOf: AtApsSpecimen
// Usage: #inline
// * subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Anton Testpatient"
...
// Instance: example-iv-5-poc-diagnostic-result-8
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
// * performer = Reference(urn:uuid:26d8cedc-b202-4620-84c0-d5c7d602ac66) "Amadeus Spital - Labor"
...
// Instance: example-iv-5-poc-diagnostic-result-9
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
// * specimen = Reference(urn:uuid:ee1e26a1-caba-45f7-928e-d93fc1a47da9) "Urine specimen (example-iv-5-poc-diagnostic-specimen-2)"

// Instance: example-iv-5-poc-diagnostic-result-10
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
// Instance: example-iv-5-poc-diagnostic-result-11
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
// Instance: example-iv-5-poc-diagnostic-result-12
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
// Instance: example-iv-5-poc-diagnostic-result-13
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
// Instance: example-iv-5-poc-diagnostic-result-14
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
Instance: example-iv-5-poc-vital-sign-1
...
Instance: example-iv-5-poc-vital-sign-2
InstanceOf: AtApsObservationVitalSigns
Usage: #inline
* status = #final
* category[VSCat] = $cs-observation-category#vital-signs "Vital Signs"
...
Instance: example-iv-5-poc-vital-sign-3
InstanceOf: AtApsObservationVitalSigns
Usage: #inline
* status = #final
* category[VSCat] = $cs-observation-category#vital-signs "Vital Signs"
...
Instance: example-iv-5-poc-vital-sign-4
InstanceOf: AtApsObservationVitalSigns
Usage: #inline
* status = #final
* category[VSCat] = $cs-observation-category#vital-signs "Vital Signs"
...
Instance: example-iv-5-poc-vital-sign-5
InstanceOf: AtApsObservationVitalSigns
Usage: #inline
* status = #final
* category[VSCat] = $cs-observation-category#vital-signs "Vital Signs"
...
Instance: example-iv-5-poc-illness-history-1
InstanceOf: AtApsCondition
Usage: #inline
...
Instance: example-iv-5-poc-social-history-1
...
Instance: example-iv-5-poc-social-history-2
...
Instance: example-iv-5-poc-social-history-3
...
Instance: example-iv-5-poc-organization
...
// APS Generator
Instance: example-iv-5-poc-author-device
InstanceOf: AtApsDevice
Usage: #inline
* patient = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Anton Testpatient"
