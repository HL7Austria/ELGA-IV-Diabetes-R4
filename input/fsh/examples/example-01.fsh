...
// * entry[=].resource = Inline-Instance-for-example-01-5
// * entry[+].fullUrl = "urn:uuid:feb8751e-3baa-4f49-8d9e-1cd32a6c6dac"
// * entry[=].resource = Inline-Instance-for-example-01-6
...
* section[=].text.status = #empty
* section[=].text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\"><p>Körpergröße: 173cm</p><p>Gewicht: 90kg</p><p>BMI: 30.07</p><p>Blutdruck: 130/80 mmHg</p><p>Puls: 85 Schläge/min</p><p>Taillenumfang: 109cm</p></div>"
...
* section[=].text.status = #empty
* section[=].text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\"><p>Raucherstatus: Nichtraucher (40 PY)</p><p>Alkoholkonsum: 1-2 Gläser Wein/Bier pro Tag</p><p>Familienanamnese: DD Typ 2</p><p>Familienanamnese: Vorzeitige koronare Herzerkrankung</p><p>Familienstatus: Verheiratet, 2 Kinder, 2 Enkelkinder</p><p>Interesse: technisch affin</p><p>Körperliche Aktivität: 2.5 Stunden pro Woche</p></div>"
* section[=].entry[0] = Reference(urn:uuid:3f3140b1-9478-4491-b7bf-10560f38da0e)
...
//* performer = Reference(urn:uuid:75db30ee-7028-486c-929a-c5126837f472)
//* effectiveDateTime = "2023-01-01T14:00:00+00:00"
//* valueCodeableConcept = $sct#160303001 "Diabtes Mellitus Typ 2"
...
// Instance: Inline-Instance-for-example-01-5
...
// Instance: Inline-Instance-for-example-01-6
// InstanceOf: Observation
// Usage: #inline
// * id = "example-01-social-history-1"
// * meta.profile = "https://fhir.hl7.at/elga-austrianpatientsummary-r4/StructureDefinition/at-ips-observationtobaccouse"
