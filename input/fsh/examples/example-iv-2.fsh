...
* entry[=].resource = example-iv-2-author-device

// Practitioner Hausärztin
* entry[+].fullUrl = "urn:uuid:75db30ee-7028-486c-929a-c5126837f473"
* entry[=].resource = example-iv-2-practitioner-2
// Organisation
...
* entry[=].resource = example-iv-2-problem-4
...
* entry[=].resource = example-iv-2-Immunization-1
// Diagnostic Results
...
* entry[=].resource = example-iv-2-social-history-2
* entry[+].fullUrl = "urn:uuid:9add5c32-1ded-43d6-b163-c3fe13f94984"
* entry[=].resource = example-iv-2-social-history-3
...
* section[sectionProblems].text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\"><p>Arterielle Hypertonie</p><p>Adipositas</p><p>Diabettes Mellitus Typ 2</p><p>Familienanamnese: orzeitige koronare Herzerkrankung, Diabetes mellitus</p></div>"
...
* section[sectionResults].text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\"><p>Glucose im kapillaren Blut 1h postprandial</p></div>"
...
// Arzt
Instance: example-iv-2-practitioner-2
