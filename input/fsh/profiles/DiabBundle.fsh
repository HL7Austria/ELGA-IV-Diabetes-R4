...
//     DiabAllergyIntolerance 0..* and
//     Condition 0..* //and
    IvConditionDiagnose 0..1 and
//     Device 0..* and
...
//* entry[DiabAllergyIntolerance].resource 1..
//* entry[DiabAllergyIntolerance].resource only DiabAllergyIntolerance

// * entry[Condition].resource 1..
// * entry[Condition].resource only AtIpsCondition

* entry[IvConditionDiagnose].resource 1..
* entry[IvConditionDiagnose].resource only IvConditionDiagnose
...
* entry[IvCarePlanSchulung].resource 0..
* entry[IvCarePlanSchulung].resource only IvCarePlanSchulung
